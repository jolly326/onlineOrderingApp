...
<template>
  <div class="m-page">
    ...
    <!-- 今日经营概览 -->
    <div class="section-bar"><span class="section-dot"></span>今日概览</div>
    <div v-if="!loading" class="data-grid">
    ...
    <div class="settings-list">
      ...
      <div class="set-divider"></div>
      <div class="set-item" @click="router.push('/merchant')">
        <span class="set-emoji">🏪</span>
        <span class="set-label">返回管理</span>
        <van-icon name="arrow" color="#ddd" size="20" />
      </div>
    </div>
...
/* ===== 数据卡片（与管理页一致） ===== */
.data-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; padding: 0 24px 4px; }
